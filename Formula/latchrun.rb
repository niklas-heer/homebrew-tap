class Latchrun < Formula
  ...
  on_macos do
    ...
    on_arm do
      url "https://github.com/niklas-heer/latchrun/releases/download/v#{version}/latchrun-v#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "ad468c1d6c3b547979d774e3c226b109de2c63b4fe5948e939bc949e3d557094"
    end

    on_intel do
      url "https://github.com/niklas-heer/latchrun/releases/download/v#{version}/latchrun-v#{version}-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/niklas-heer/latchrun/releases/download/v#{version}/latchrun-v#{version}-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "a5833c73c9095e9a5c9231ef20f582e0f177b61ec2335a23859c43cfde755258"
    end

    on_intel do
      url "https://github.com/niklas-heer/latchrun/releases/download/v#{version}/latchrun-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
